...
<tr><td>Address:<br>
           ...
           <tr><td> Gender:<br>
           <tr><td> <input type="radio" id="male" name="gender" value="male" required>
           <tr><td> Male
           <tr><td> <input type="radio" id="female" name="gender" value="female" required>
          <tr><td>  Female
          <tr><td> <input type="radio" id="other" name="gender" value="other" required>
            Other<br><br>
...
<?php
    ...
    if(isset($_POST['txtfnm']))
    {
       $fnm=$_POST['txtfnm'];
			 ...
			 $gender=$_POST['gender'];
       $sql="INSERT INTO `phptrip`(`firstname`,`lastname`,`connectno`,`email`,`select country`,`select state`,`select city`,`address`,`gender`) VALUES ('$fnm','$lnm','$cno','$email','$country','$state','$city','$adress','$gender')";
